...
// 	protoc        v4.23.1
// source: proto/CompoundBoostTakeStatusType.proto
...
func (CompoundBoostTakeStatusType) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_CompoundBoostTakeStatusType_proto_enumTypes[0].Descriptor()
}

func (CompoundBoostTakeStatusType) Type() protoreflect.EnumType {
	return &file_proto_CompoundBoostTakeStatusType_proto_enumTypes[0]
}
...
func (CompoundBoostTakeStatusType) EnumDescriptor() ([]byte, []int) {
	return file_proto_CompoundBoostTakeStatusType_proto_rawDescGZIP(), []int{0}
}

var File_proto_CompoundBoostTakeStatusType_proto protoreflect.FileDescriptor

var file_proto_CompoundBoostTakeStatusType_proto_rawDesc = []byte{
	0x0a, 0x27, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x43, 0x6f, 0x6d, 0x70, 0x6f, 0x75, 0x6e, 0x64,
	0x42, 0x6f, 0x6f, 0x73, 0x74, 0x54, 0x61, 0x6b, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x54,
	0x79, 0x70, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2a, 0xc5, 0x01, 0x0a, 0x1b, 0x43, 0x6f,
	...
	0x03, 0x42, 0x1d, 0x5a, 0x1b, 0x47, 0x6f, 0x2d, 0x47, 0x72, 0x61, 0x73, 0x73, 0x63, 0x75, 0x74,
	0x74, 0x65, 0x72, 0x2f, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x64, 0x2f, 0x70, 0x62,
	0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_proto_CompoundBoostTakeStatusType_proto_rawDescOnce sync.Once
	file_proto_CompoundBoostTakeStatusType_proto_rawDescData = file_proto_CompoundBoostTakeStatusType_proto_rawDesc
)

func file_proto_CompoundBoostTakeStatusType_proto_rawDescGZIP() []byte {
	file_proto_CompoundBoostTakeStatusType_proto_rawDescOnce.Do(func() {
		file_proto_CompoundBoostTakeStatusType_proto_rawDescData = protoimpl.X.CompressGZIP(file_proto_CompoundBoostTakeStatusType_proto_rawDescData)
	})
	return file_proto_CompoundBoostTakeStatusType_proto_rawDescData
}

var file_proto_CompoundBoostTakeStatusType_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_proto_CompoundBoostTakeStatusType_proto_goTypes = []interface{}{
	(CompoundBoostTakeStatusType)(0), // 0: CompoundBoostTakeStatusType
}
var file_proto_CompoundBoostTakeStatusType_proto_depIdxs = []int32{
...
func init() { file_proto_CompoundBoostTakeStatusType_proto_init() }
func file_proto_CompoundBoostTakeStatusType_proto_init() {
	if File_proto_CompoundBoostTakeStatusType_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_proto_CompoundBoostTakeStatusType_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_proto_CompoundBoostTakeStatusType_proto_goTypes,
		DependencyIndexes: file_proto_CompoundBoostTakeStatusType_proto_depIdxs,
		EnumInfos:         file_proto_CompoundBoostTakeStatusType_proto_enumTypes,
	}.Build()
	File_proto_CompoundBoostTakeStatusType_proto = out.File
	file_proto_CompoundBoostTakeStatusType_proto_rawDesc = nil
	file_proto_CompoundBoostTakeStatusType_proto_goTypes = nil
	file_proto_CompoundBoostTakeStatusType_proto_depIdxs = nil
}
